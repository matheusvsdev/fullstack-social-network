...
import com.matheusdev.backendjava.config.customgrant.CustomPasswordAuthenticationConverter;
import com.matheusdev.backendjava.config.customgrant.CustomPasswordAuthenticationProvider;
import com.matheusdev.backendjava.config.customgrant.CustomUserAuthorities;
...
public class AuthorizationServerConfig {
	...
	@Bean
	@Order(1) // Define a ordem do filtro na cadeia de segurança
